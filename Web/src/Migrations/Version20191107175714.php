 ...
 */
final class Version20191107175714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, id_activity_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_5E90F6D699D2AD61 (id_activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
